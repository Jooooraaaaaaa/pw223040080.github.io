...
<form action="" method="POST"class="login-email">
    <p align=center style="font-size: 3rem; font-weight:850; margin-bottom:20px; ">LOGIN</p>
    ...
    <p align=center class="login-register-text">Tidak Memiliki Akun? <a href="register.php">Daftar</a></p>
</form>
</div>
